...
/**
 * Servlet implementation class LoadChangeController
 */
@WebServlet("/user/loadCart")
public class LoadChangeController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LoadChangeController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		cartItemDAO.UpdateQuantity(iId, iquantity);
